...
@section('title')
    المستخدمين - إعداد القاده التدريب
@stop
                    ...
                    <table class="table table-hover" id="example1" data-page-length='50' style=" text-align: center;">
                        <thead>
                            <tr>
                                ...
                                <th class="wd-15p border-bottom-0" style="width: 5%">حالة المستخدم</th>

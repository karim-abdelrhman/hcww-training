                ...
                <div class="card-header pb-0">
                    <div class="d-flex justify-content-between">
                        ...
                        <a class="modal-effect btn btn-outline-primary" data-effect="effect-scale"
                           data-toggle="modal" href="#modaldemo8">اضافة الدرجة</a>
                        {{--                        @endcan--}}
                    </div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a class="modal-effect btn btn-sm btn-info" data-effect="effect-scale"
                                           data-id="{{ $grade->id }}" data-code="{{ $grade->code }}"
                                           data-a_name="{{ $grade->a_dsc }}" data-e_name="{{ $grade->e_dsc }}"
                                           data-toggle="modal"
                                        ...
                                        <a class="modal-effect btn btn-sm btn-danger" data-effect="effect-scale"
                                           data-id="{{ $grade->id }}" data-a_name="{{ $grade->a_dsc }}"
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content modal-content-demo">
                    <div class="modal-header">
                        <h6 class="modal-title">اضافة درجة مالية</h6><button aria-label="Close" class="close" data-dismiss="modal"

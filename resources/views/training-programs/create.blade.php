                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                                ...
                                <div class="row mb-3">
                                    <div class="col-6 mb-3">
                                        ...
                                        <input type="text" class="form-control @error('name') is-invalid @enderror"
                                               name="name" value="{{old('name')}}" title="يرجي ادخال أسم المدرب"
                                               required>
                                        @error('name')
                            ...
                            <div class="col-md-5">
                                ...
                                <div class="row mb-3">
                                    <div class="col-6 mb-3">
                                        ...
                                        <input type="text"
                                               ...
                                               value="{{old('coach_accreditation_number')}}"
                                               required>
                                    ...
                                    <div class="col-6 mb-3">
                                        ...
                                        <input type="date"
                                               ...
                                               value="{{old('coach_accreditation_date')}}"
                                               required>
                                    ...
                                    <div class="col-6 mb-3">
                                        ...
                                        <input id="coach_accreditation" type="file" name="coach_accreditation"
                                    ...
                                    <div class="col-6 mb-3">
                                        ...
                                        <input type="file" id="interview_evaluation" name="interview_evaluation"
                                    ...
                                    <div class="col-6 mb-3">
                                        <label for="job_description">خطاب الإسناد</label>
                                        <input type="file" id="letter_of_attribution" name="letter_of_attribution"
                                ...
                                <div class="label heading-info text-center mb-3">شهادات الإعتماد</div>
                                <div class="row mb-3" id="certificates">
                                    <div class="col-12 mb-4 @error('accreditation_certificates') is-invalid @enderror"
                            ...
                            <div class="col-md-2">
                                <div class="row">
                                    <div class="label heading-info text-center mb-3">صورة المدرب</div>
                                    <div class="col-12">
                                        <div class="inline-inputs mb-3">
                                            <label class="image-input admin-avatar">
                                                ...
                                                <img src="{{asset('')}}assets/admin/img/img-placeholder.png"
                                ...
                                <div class="row">
                                    <div class="label heading-info text-center mb-3">صورة البطاقة</div>
                                    <div class="col-12">
                                        <div class="inline-inputs mb-3">
                                            <label class="image-input admin-avatar">
                                                <input hidden type="file" name="id_image" accept="image/*"

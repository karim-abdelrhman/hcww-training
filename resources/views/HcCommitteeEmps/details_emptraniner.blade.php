...
@section('page-header')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto"><a href="{{route('dashboard')}}"> اللجان والبرامج المنفذه</a>
                </h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/<a href="{{route('Trainer.index')}}">اسماء المتدربين فى اللجنه</a>
                     </span><span class="text-muted mt-1 tx-13 mr-2 mb-0">/
                    تفاصيل اسماء المتدربين باللجنه</span>
            </div>
        </div>
                                ...
                                <div class=" tab-menu-heading">
                                    <div class="tabs-menu1">
                                        ...
                                        <ul class="nav panel-tabs main-nav-line">
                                            ...
                                            <li><a href="#tab5" class="nav-link" data-toggle="tab">اسماء المتدربين</a></li>
                                        </ul>
                                    </div>
                                </div>
...
{{--                                                        <td>{{ $masters->ms_id }}</td>--}}
                                        ...
                                        <div class="tab-pane" id="tab5">
                                            <div class="card-body">
                                                <h5 class="card-title">اضافة متدرب</h5>
                                                <form method="post" action="{{ route('Trainer.store') }}"
                                                      enctype="multipart/form-data">
                                                    {{ csrf_field() }}
                                                    <div class="row">
                                                        <div class="col">
                                                            <label for="Members" class="control-label">اسم المتدرب</label>
                                                            <select class="form-control" id="nameEmp" style="text-align: center" name="NameEmp" id="Members">
                                                        ...
                                                        <input type="hidden" id="prog_id" name="Pro_Id" value="{{ $masters->ms_id }}">
      ...
      <div class="modal fade" id="select2modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
          ...
          <div class="modal-dialog" role="document">
              <div class="modal-content">
                  ...
                  <form action="{{ route('Trainer.update', 'test') }}" method="post">
                      {{ method_field('patch') }}
                      {{ csrf_field() }}
                      <div class="modal-body">
                          <div class="form-group">
                              ...
                              <label for="Emp_code" class="control-label">كود المتدرب</label>
                              <input type="text" id="Emp_code" name="Emp_code" value="" class="form-control">
                          </div>
                          <div class="form-group">
                              <label for="Mem_name" class="control-label">اسم المتدرب</label>
...
@section('js')
    ...
    <script>
        ...
        $('#select2modal').on('show.bs.modal', function(event) {
            ...
            var Emp_code = button.data('Emp_code')
            var modal = $(this)

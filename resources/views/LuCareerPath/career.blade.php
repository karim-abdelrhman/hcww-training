    ...
    <div class="row">
            ...
            <div class="card mg-b-20">
                <div class="card-header pb-0">
                    <div class="d-flex justify-content-between">
                        @can('bt-add-carer')
                            <a class="modal-effect btn btn-outline-primary " data-effect="effect-scale" data-toggle="modal" href="#exampleModal">إضافة مسار وظيفى</a>
                        @endcan
                    </div>
                </div>
                <div class="card-body">
        ...
        <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <form action="{{ route('careers.store') }}" method="post" autocomplete="off">
                        {{ csrf_field() }}
                        <div class="modal-body">
                            ...
                            <div class="form-group">
                                <label for="exampleInputEmail1"> المسار الوظيفي</label>
                ...
                <div class="modal-content">
                    ...
                    <form action='careers/update' method="post">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="form-group">
                                <label for="title">المسار الوظيفى:</label>
        ...
        <div class="modal fade" id="modaldemo9" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title">حذف المسار</h5>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>

        ...
        <div class="col-lg-12 col-md-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="{{ url('trainees/update') }}" method="post" autocomplete="off">
                        {{ method_field('patch') }}
                        {{ csrf_field() }}
                        {{-- 1 --}}
                        <div class="row">
                            <div class="col">
                                ...
                                <input type="text" class="form-control" id="inputName" name="a_name"
                                       title="يرجي ادخال اسم المتدرب" value="{{ $emps->a_name }}" required>
                            </div>
                            ...
                            <div class="col">
                                ...
                                <input class="form-control fc-datepicker" name="grade_Date" placeholder="YYYY-MM-DD"
                                       type="text" value="{{ $emps->grade_date}}" required>
                            </div>
                        </div>

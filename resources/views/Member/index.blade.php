                        ...
                        <table id="example1" class="table key-buttons text-md-nowrap" data-page-length='20'>
                            ...
                            @foreach ($comps as $comp)
                                ...
                                <tr>
                                    <td>{{ $i }}</td>
                                    <td>{{ $comp->code }}</td>
                                    <td><a href="{{ route('members.show', $comp->id) }}">{{ $comp->name }}</a></td>
                                    <td>
{{--                                        @can('bt-edit-employee')--}}
                                            <a class="btn btn-primary btn-sm"
                                               href="{{ route('members.create', $comp->id) }}">إضافه عضو جديد</a>
{{--                                        @endcan--}}
{{--                                        @can('bt-show-employee')--}}
                                            <a class="btn btn-success btn-sm"
                                               href="{{ route('members.show', $comp->id) }}">عرض اعضاء اللجنه والتعديل عليها</a>
{{--                                    @endcan--}}
                                </tr>
                            @endforeach
                            </tbody>

							...
							<li class="">
								<div class="dropdown  nav-itemd-none d-md-flex">
									<a href="#" class="d-flex  nav-item nav-link pl-0 country-flag1" data-toggle="dropdown" aria-expanded="false">
										<span class="avatar country-Flag mr-0 align-self-center bg-transparent"><img src="{{URL::asset('assets/img/flags/egypt_flag.jpg')}}" alt="img"></span>
										<div class="my-auto">
						...
						<div class="nav nav-item  navbar-nav-right ml-auto">
							...
							<div class="dropdown main-profile-menu nav nav-item nav-link">
								<a class="profile-user d-flex" href="">
                                    @if(Auth::user()->image)
                                        <div class="  drop-img  cover-image  " alt="profile_image" data-image-src="{{URL::asset('assets/img/faces/'.Auth::user()->image)}}">
                                            <span class="avatar-status bg-teal"></span>
                                        </div>
                                    @else
                                        <div class="  drop-img  cover-image  " alt="profile_image" data-image-src="{{URL::asset('assets/img/faces/6.jpg')}}">
                                            <span class="avatar-status bg-teal"></span>
                                        </div>
                                    @endif
                                </a>
								<div class="dropdown-menu">
									<div class="main-header-profile bg-primary p-3">
										<div class="d-flex wd-100p">
											<div class="main-img-user">
                                                @if(Auth::user()->image)
                                                    <img alt="" src="{{URL::asset('assets/img/faces/'.Auth::user()->image)}}" class="">
                                                @else
									...
									<a class="dropdown-item" href="{{ url('/editprofile') }}/{{ Auth::user()->id }}"><i class="bx bx-user-circle"></i>الملف الشخصى</a>

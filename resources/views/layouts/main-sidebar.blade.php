...
<aside class="app-sidebar sidebar-scroll">
    <div class="main-sidebar-header active">
        <a class="desktop-logo logo-light active" href="{{ url('/' . $page='dashboard') }}"><img
                src="{{URL::asset('assets/img/brand/logo1.jpg')}}" class="main-logo" alt="logo"></a>
        <a class="desktop-logo logo-dark active" href="{{ url('/' . $page='dashboard') }}"><img
                src="{{URL::asset('assets/img/brand/logo-white1.png')}}" class="main-logo dark-theme" alt="logo"></a>
        <a class="logo-icon mobile-logo icon-light active" href="{{ url('/' . $page='dashboard') }}"><img
                src="{{URL::asset('assets/img/brand/favicon2.png')}}" class="logo-icon" alt="logo"></a>
        <a class="logo-icon mobile-logo icon-dark active" href="{{ url('/' . $page='dashboard') }}"><img
                src="{{URL::asset('assets/img/brand/favicon-white1.png')}}" class="logo-icon dark-theme" alt="logo"></a>
    </div>
    <div class="main-sidemenu">
                ...
                <div class="">
                    @if(Auth::user()->image)
                        <img alt="user-img" class="avatar avatar-xl brround"
                             src="{{URL::asset('assets/img/faces/'.Auth::user()->image)}}"><span
        ...
        <ul class="side-menu">
            <li class="side-item side-item-category">برنامج إعداد القادة</li>
            <li class="slide">
            ...
            <li class="side-item side-item-category">التعريفات الاساسية</li>
            <li class="slide">
                <a class="side-menu__item" data-toggle="slide" href="{{ url('/' . $page='#') }}">
                    ...
                    <span class="side-menu__label">تعريفات</span><i class="angle fe fe-chevron-down"></i></a>
                <ul class="slide-menu">

                    <li><a class="slide-item" href="{{ url('/careers') }}">المجموعة النوعية</a></li>
                    <li><a class="slide-item" href="{{ url('/positions') }}">المسمى الوظيفى</a></li>
                    <li><a class="slide-item" href="{{ url('/grades') }}">الدرجة المالية</a></li>
                    <li><a class="slide-item" href="{{ url('/degrees') }}">المؤهل</a></li>
                    <li><a class="slide-item" href="{{ url('/jobs') }}">الوظيفة</a></li>
                    <li><a class="slide-item" href="{{ url('/orgunits') }}">الإدارات</a></li>
                    <li><a class="slide-item" href="{{ url('/faculty') }}">الكلية</a></li>
                    <li><a class="slide-item" href="{{ url('/training_place') }}">اماكن التدريب</a></li>
                </ul>
            </li>
            <li class="side-item side-item-category">العاملين</li>
            <li class="slide">
                <a class="side-menu__item" data-toggle="slide" href="{{ url('/' . $page='#') }}">
                    ...
                    <span class="side-menu__label" style="margin-right: 5px;">الموظفين</span>
                    <i class="angle fe fe-chevron-down"></i></a>
                <ul class="slide-menu">
                    <li><a class="slide-item" href="{{ url('/employee') }}"> الموظفين </a></li>
                </ul>
            </li>
            <li class="side-item side-item-category">التدريب</li>
            <li class="slide">
                <a class="side-menu__item" href="{{ route('training-centers.index') }}">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
                         stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                    ...
                    <span class="side-menu__label" style="margin-right: 5px;">مراكز التدريب</span>
                </a>
                <a class="side-menu__item" href="{{ route('trainers.index') }}">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
                         stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                    ...
                    <span class="side-menu__label" style="margin-right: 5px;">المدربين</span>
                </a>
                {{--                <ul class="slide-menu">--}}
                {{--                    <li><a class="slide-item" href="{{ route('training-centers.index') }}"> مراكز التدريب </a></li>--}}
                {{--                </ul>--}}
            </li>
            <li class="side-item side-item-category"> البرامج التدريبية</li>
            <li class="slide">
                <a class="side-menu__item" data-toggle="slide" href="{{ url('/' . $page='#') }}">
                    <svg xmlns="http://www.w3.org/2000/svg" class="side-menu__icon" viewBox="0 0 24 24">
                        <path d="M0 0h24v24H0V0z" fill="none"/>
                    ...
                    <span class="side-menu__label">البرامج والمواد التدريبية </span>
                    <i class="angle fe fe-chevron-down"></i></a>
                <ul class="slide-menu">
                    <li><a class="slide-item" href="{{ url('/train_program') }}"> البرامج التدريبية </a></li>
                </ul>
            </li>
            <li class="side-item side-item-category">اللجان</li>
            <li class="slide">
                <a class="side-menu__item" data-toggle="slide" href="{{ url('/' . $page='#') }}">
                    <svg xmlns="http://www.w3.org/2000/svg" class="side-menu__icon" viewBox="0 0 24 24">
                        <path d="M0 0h24v24H0V0z" fill="none"/>
                    ...
                    <span class="side-menu__label">اللجان الدائمة</span>
                    <i class="angle fe fe-chevron-down"></i>
                </a>
                <ul class="slide-menu">
                    <li><a class="slide-item" href="{{ url('/comps') }}">إضافه اعضاء اللجان</a></li>
                    <li><a class="slide-item" href="{{ route('companies-committees.index') }}">لجان الدائمة للشركات</a>
                    </li>
                    <li><a class="slide-item" href="{{ url('/meeting') }}">محضر اجتماع اللجنة</a></li>
                    <li><a class="slide-item" href="{{ url('/Trainer') }}">إضافة متدربين للجنة</a></li>
                </ul>
            </li>
            <li class="slide">
                <a class="side-menu__item" data-toggle="slide" href="{{ url('/' . $page='#') }}">
                    ...
                    <span class="side-menu__label">الدورات التدريبية</span>
                    <i class="angle fe fe-chevron-down"></i>
                </a>
                <ul class="slide-menu">
                    <li><a class="slide-item" href="{{ url('/Assessment') }}">التقييم</a></li>
                    <li><a class="slide-item" href="#">الدوره التدريبية</a></li>
                </ul>
            </li>
            ...
            <li class="slide">
                ...
                <ul class="slide-menu">
                    ...
                    {{--                            @endcan--}}
                    {{--                            @can('permPage')--}}
                    <li><a class="slide-item" href="{{ url('/' . ($page = 'permission')) }}">صلاحيات الشاشات</a></li>
                    {{--                            @endcan--}}
                </ul>
            </li>

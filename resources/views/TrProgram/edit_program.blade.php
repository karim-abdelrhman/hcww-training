                                        ...
                                        <div class="tab-pane active" id="tab4">
                                            <div class="table-responsive mt-15">
                                                ...
                                                <table class="table table-striped" style="text-align:center">
                                                    <tbody>
                                                    <tr>
                                                        <th scope="row">كود البرنامج</th>
                                                        <td>{{ $programs->code }}</td>
                                                        <th scope="row">اسم البرنامج</th>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a class="modal-effect btn btn-sm btn-info" data-effect="effect-scale"
                                                               ...
                                                               data-a_name="{{ $programs->program_name }}"
                                                               data-e_name="{{ $programs->comm }}"
                                                               data-toggle="modal"
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td colspan="2">
                                                                    ...
                                                                    <a class="btn btn-outline-success btn-sm"
                                                                       href="{{ url('View_file') }}/{{ $programs->code }}/{{ $attachment->file_name }}"
                                                                       role="button"><i class="fas fa-eye"></i>&nbsp;
                                                                        عرض</a>

                                                                    <a class="btn btn-outline-info btn-sm"
                                                                       href="{{ url('download') }}/{{ $programs->code }}/{{ $attachment->file_name }}"
                                                                       role="button"><i
